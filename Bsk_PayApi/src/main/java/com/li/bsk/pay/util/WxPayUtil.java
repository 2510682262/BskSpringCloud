package com.li.bsk.pay.util;

import com.li.bsk.common.util.HttpUtil;
import com.li.bsk.pay.wechatpay.WXPayConstants;
import com.li.bsk.pay.wechatpay.WXPayXmlUtil;
...
public class WxPayUtil {
    ...
    public WxPayUtil(String appid, String mch_id, String appkey, String sign_type) {
        this.appid = appid;
        this.mch_id = mch_id;
        this.appkey = appkey;
